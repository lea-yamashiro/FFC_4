...
second5_noise = np.arange(162, 168, 1)
flops = {}
point = 0
try:
    for i in second5_noise:
        ...
        if (15 < alt < 85) and (5 < az < 350):
            ...
            np.savez(f'obs_042424/Noise_Spectra/NoiseSpec{i}_L{ra_pointing.iloc[i,1]:.0f}_B{ra_pointing.iloc[i,2]:.0f}.npz'.format(str),
