...
try:
    for i in missed_042424:
        ...
        if (15 < alt < 85) and (5 < az < 350):
            ...
            np.savez(f'obs_042424/spec{i}_2_L{ra_pointing.iloc[i,1]:.0f}_B{ra_pointing.iloc[i,2]:.0f}.npz'.format(str),
            ...
            flops.update({point:[alt,az],'index':i})
            continue
